final String appName = ' Buybtoc Seller';

final String packageName = 'com.buybtoc.seller';

final String iosPackage = 'com.buybtoc.seller';
...
final String baseUrl = 'https://buybtoc.com/seller/app/v1/api/';
